...
- Bumped `next` to `16.3.3` (and `eslint-config-next` to match), resolving a
  critical unauthenticated remote-code-execution advisory in the Image
  Optimization API when AVIF files are optimised
